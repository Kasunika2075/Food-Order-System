...
$user = $userObj->searchItemsByID($restaurentID);
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-light" style="background-color: #212529;">
                    <div class="form-outline form-white h5">
                        ...
                        <br />
                        <label class="form-label h5" for="tel">Price</label>
                        <br />
                        <input type="text" class="form-control" name="price" id="price" required />
                        <br />
                        <label class="form-label h5" for="tel">Image</label>
                        <br />
                        <input type="file" class="form-control" name="image" id="image" required />
                        <br />
                        <input type="hidden" name="restaurant_id" value="<?php echo $restaurentID;?>">
<!--                        assign $restaurentID to the value-->
                    </div>
                </div>
...
<div class="container" id="table" style="margin-bottom: 70px;">
    <div class="table-responsive">
        <table class="table" id="tbl_admin">
            <thead style="text-align: center">
            <tr>
                <th class="fs-3">Food Image</th>
                <th class="fs-3">Name</th>
                <th class="fs-3">Price</th>
                <th class="fs-3" colspan="2">Action</th>
            </tr>
            </thead>
            <tbody style="text-align: center">
                ...
                ?>
                <tr>
                    <td><img src="<?php echo $customer->menu_item_picture;?>" alt="" style="width: 50px"></td>
                    <td><?php echo $customer->menu_item_name;?></td>
                    <td>Rs.<?php echo $customer->menu_item_price;?></td>
                    <td>
                        <a href="editFood.php?menu_item_id=<?php echo $customer->menu_item_id;?>">
                            <button class="btn btn-danger btnedit" type="submit" name="edit">Edit</button>
                        </a>
                    </td>
                    <td>
                        <a href="deleteFood.php?menu_item_id=<?php echo $customer->menu_item_id;?>">
