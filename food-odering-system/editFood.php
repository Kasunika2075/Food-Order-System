...
//    $restaurentID = 1;
    ...
    $userObj->updateFood($name, $price, $image, $restaurentID, $menu_item_id);
    ...
    if (isset($_GET["menu_item_id"])) {
        ...
        $user = $userObj->getFoodByID($menu_item_id);
    }
}
    ...
    <nav class="navbar navbar-expand-md bg-dark py-3 navbar-dark">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"><img class="navbar-logo" src="assets/img/logo.png" style="width: 5rem;padding: 0.5rem;"></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-5"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-5">
                ...
                </ul><a class="btn btn-primary ms-md-2 btn-all" role="button" href="<?php echo $link;?>" style="background: var(--bs-warning);">Logout</a>
            </div>
        </div>
    </nav>
</div>
<form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post" enctype="multipart/form-data" style="padding: 10rem">
    <input type="hidden" name="menu_item_id" value="<?php echo $user->menu_item_id;?>">
    <div class="form-group">
        <h3 style="color: white">Food name : </h3><input type="text" class="form-control" id="name" name="name" value="<?php echo $user->menu_item_name;?>">
    </div>
    <div class="form-group">
        <h3 style="color: white">Price : </h3><input type="text" class="form-control" id="price" name="price" value="<?php echo $user->menu_item_price;?>">
    </div>
    <div class="form-group">
        <h3 style="color: white">Image : </h3><input type="file" class="form-control" id="image" name="image" value="<?php echo $user->menu_item_picture;?>">
    </div>
    <button type="submit" class="btn btn-primary btnedit" style="margin-top: 1.5rem">Update</button>
</form>
<div id="footer">
